...
I would like to be able to post emojis and stickers to my page.
```
```
As a user
So that I have a lot of fun
I would like to be able to post emojis and stickers as comments on other posts.
```
```
As a user
So that I can promote my blog
I would like to be able to have a web address associated with my account.
```
